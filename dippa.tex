...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Facilitation in product development project:}
\newcommand{\FTITLE}{Tuotekehitysprojektin fasilitointi:}
\newcommand{\SUBTITLE}{The benefits of facilitation?!}
\newcommand{\FSUBTITLE}{Fasilitoinnin hyödyt}
\newcommand{\DATE}{December xx, 2013}
\newcommand{\FDATE}{xx. joulukuuta 2013}
...
\newcommand{\SUPERVISOR}{Professor Kalevi Ekman\\
  Professor Riitta Smeds}
\newcommand{\FSUPERVISOR}{Professori Kalevi Ekman\\
  Professori Riitta Smeds}


% If you have only one instructor, just write one name here
\newcommand{\INSTRUCTOR}{Päivi Pöyry-Lassila M.Sc. (Tech.)?!}
\newcommand{\FINSTRUCTOR}{(Diplomi-insinööri?!) Päivi Pöyry-Lassila}
...
\newcommand{\COVERSUPERVISOR}{Professor Kalevi Ekman, Aalto University\\
  Professor Riitta Smeds, Aalto University}
...
\newcommand{\PROFCODE}{TU ?!}
\newcommand{\KEYWORDS}{product development, facilitation}
\newcommand{\FKEYWORDS}{tuotekehitys, fasilitointi}
\newcommand{\LANGUAGE}{English}
\newcommand{\FLANGUAGE}{Englanti}

% Author is the same for all languages
\newcommand{\AUTHOR}{Heidi Tulensalo}
...
\fixme{TÄHÄN abstrakti teksti suomeksi.}}
...
\fixme{I wish to thank all those people who helped me out during this process.}
